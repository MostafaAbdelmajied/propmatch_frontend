...
import { BarChart3, ClipboardCheck, Globe, Headset, ScrollText, Users, UserX, UserCheck } from "lucide-react";
...
const links: AdminLink[] = [
  ...
  { href: "/admin/users", label: "المستخدمون", Icon: UserX, exact: false, cap: "user:delete" },

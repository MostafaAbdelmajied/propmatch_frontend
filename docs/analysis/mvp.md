...
| Ticket                                                              | Frontend scope                                                                                 | Status                                                                                                       |
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **PRO-14** Paymob iframe + webhook-driven entitlement               | Premium Owner, Boost, AI Add-on, and Documentation Pack; post-success entitlement confirmation | ✅ revised broker-free catalog and webhook fulfillment implemented                                           |
...
8. Backend PDF + persisted `LEASE_CONTRACT` (PRO-15) — _backend-owned._
